...
const Experience = () => {
    return (
        <div className='bg-[#F5F7F9] my-20'>
            <div className='container mx-auto py-20'>
                <div className='flex flex-col md:flex-row items-center justify-between'>
                    <div className='text-[#151515] p-4 md:w-1/2'>
                        <div className='my-6'>
                            <h2 className='text-3xl font-semibold my-4'>Experience a quicker, simpler, and more reliable awesome service </h2>
                        ...
                        <Link to={"/register"} 
                        className='btn text-right btn-lg text-base bg-[#04B2B2] hover:bg-[#038787] text-white mt-4'>Register Now</Link>
                    </div>
